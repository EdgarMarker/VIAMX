...
export async function generateStaticParams() {
  ...
  return posts
    ...
    .map((p) => ({ slug: p.general.slug.current }));
}
      ...
      <section className="section__content">
        <div className="column__2">
          <div className="col__left">
            ...
            {/* HERO inline (Hero component está pendiente de activar) */}
            <section className="section__hero">
              <div className="column__1">
                ...
                <div className="heading">
                  <h1>{data.general.string_general_title}</h1>
                </div>
                <div className="author">
                  <span>
                    Por <strong>{data.general.ref_general_author?.string_author_name}</strong>
                    {" | "}
                    {data.general.date}
                  </span>
                </div>
                <div className="image__wrapper">
                  <ResponsiveImage imageData={data.general.img_general_primaryImg} variant="hero" />
                </div>
              </div>
            </section>
            ...
            <div className="section__author">
              ...
              <div className="sa__right">
                ...
                <h5>
                  ...
                  {" | "}
                  <span>{data.general.ref_general_author?.string_author_position}</span>
                </h5>
              ...
              <div className="section__prev__next">
                <div className="column__2">
                  <div className="col__left card">
                    {prevPost ? (
                      <Link className="btn__prev__next btn__prev" href={`/blog/${prevPost.general.slug.current}`}>
                        <div className="prevnext__img">
                          <ResponsiveImage imageData={prevPost.general.img_general_primaryImg} variant="card" />
                        </div>
                        <div className="prevnext__data">
                          <span><Svg variant="Arrow" />Anterior artículo</span>
                          <h2>{prevPost.general.string_general_title}</h2>
                          <h3>{prevPost.general.ref_general_category?.general.string_category_name}</h3>
                        </div>
                      </Link>
                    ) : (
                      <span />
                  ...
                  <div className="col__right card">
                    {nextPost ? (
                      <Link className="btn__prev__next btn__next" href={`/blog/${nextPost.general.slug.current}`}>
                        <div className="prevnext__img">
                          <ResponsiveImage imageData={nextPost.general.img_general_primaryImg} variant="card" />
                        </div>
                        <div className="prevnext__data">
                          <span>Siguiente artículo <Svg variant="Arrow" /></span>
                          <h2>{nextPost.general.string_general_title}</h2>
                          <h3>{nextPost.general.ref_general_category?.general.string_category_name}</h3>
                        </div>
                      </Link>
                    ) : (
                      <span />
                  ...
                  <li key={idx}>
                    <div className="rc__left">
                      <Link href={`/blog/${post.general.slug.current}`}>
                        <ResponsiveImage imageData={post.general.img_general_primaryImg} variant="card" />
                      </Link>
                    </div>
                    <div className="rc__right">
                      ...
                      <Link href={`/blog/categoria/${post.general.ref_general_category?.general.slug.current}`}>
                        <h5>{post.general.ref_general_category?.general.string_category_name}</h5>
                      </Link>
                    </div>
                  </li>
                ))}
